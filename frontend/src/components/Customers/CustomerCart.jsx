...
export default function CustomerCart({ loggedInAs, cart, setCart, customerCart = {} }) {
  ...
  */
  ...
  /*
  With Jinseok's implementation, completion of checkout gives message and redirect, so no . . . checkoutComplete . . . necessary.
  Except if the page crashes, but the whole thing is shambles anyways.
  */
